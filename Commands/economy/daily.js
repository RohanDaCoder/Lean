...
module.exports = {
  ...
  run: async ({ client, interaction }) => {
    ...
    if (lastClaimed && timeSinceLastClaimed < twelveHoursInMillis) {
      ...
      const remainingTimeInHours = Math.ceil(
        remainingTimeInMillis / (60 * 60 * 1000),
      );
      await interaction.editReply(
        `You have already claimed your daily coins. Please wait ${remainingTimeInHours} hours before claiming again.`,
      );
      return;
    }
